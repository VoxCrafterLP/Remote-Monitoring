package com.voxcrafterlp.monitoring.server.threads;
        ...
        try {
            while ((line = reader.readLine()) != null) {
                ...
                if(line.equalsIgnoreCase("help") || line.equalsIgnoreCase("?")) {
                    ...
                    new Logger().log(LogLevel.INFORMATION, "- stop / shutdown : Stops the server");
                    new Logger().log(LogLevel.INFORMATION, "- reload : Reloads the configuration of the server");
                    new Logger().log(LogLevel.INFORMATION, "==============================");
                } else
