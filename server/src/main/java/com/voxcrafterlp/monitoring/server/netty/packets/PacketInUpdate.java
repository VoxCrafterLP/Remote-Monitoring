...
@Getter
public class PacketInUpdate implements Packet {
    ...
    public PacketInUpdate() {}

    public PacketInUpdate(int cpuUtilization, double cpuTemperature, int memoryUsed, int swapUsed) {
